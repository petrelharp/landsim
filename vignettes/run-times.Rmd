...
germination_fun <- function (N,carrying.capacity,...) {
    germination.args$r0 / ( 1 + migrate_raster(raster::sum(N),germination.args$competition)/carrying.capacity )
}
...
matrix.germination.args$competition <- migration( matrix.germination.args$competition, do.M=TRUE, population=habitat )
matrix.demography$prob.germination <- function (N,carrying.capacity,...) {
    matrix.germination.args$r0 / ( 1 + migrate(matrix.germination.args$competition,x=N)/carrying.capacity )
}
